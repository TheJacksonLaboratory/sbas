...
save.image('/Users/karleg/Dimorph/RDATA/figureS4.RData')
...
load('figureLeftVentricleS3.RData')
library(ggplot2)
library(ggsci)
library(latex2exp)
...
par(mar=c(5,5,1,1))
xlab <- "more in males \U27F5 Differential expression (log FC) \U27F6 more in females"
ylab <- "more in males \U27F5 Exon skipping (log FC) \U27F6 more in females" 
...
text(0.5,0.4,"Type I",cex=2.5)
text(0.5,-0.4,"Type II",cex=2.5)
