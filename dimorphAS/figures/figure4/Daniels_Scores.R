...
#Switch types to be consistent with publication
...
# p val is 2.05e-05
my.pval = "p==2.05 %*% 10 ^ -5"  ##
pn <- pn + annotate("text", x=1.5, y=19.5, label= as.character(my.pval),parse=TRUE, fontface="bold", size=12) 
pn
