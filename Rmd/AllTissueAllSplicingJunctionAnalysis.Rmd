...
print_exploratory_plots <- function (plot, tissue_of_interest, splice_type, fromGTF, tissue_list, ijc, sjc, obj, metadata ) {
    ...
    message("Dimensions of tissue_count_obj \n", 
    ...
    message("dimensions of the ijc_tissue \n", 
        paste(  dim(ijc_tissue), collapse = "\n") )
    message("dimensions of the ijc_tissue \n", 
        paste(  dim(sjc_tissue), collapse = "\n") )
    message("dimensions of the metadata_tissue \n", 
    ...
    message("dimensions of the ijc_sex_results_refined_annotations \n", 
        paste(dim (ijc_sex_results_refinedAnnotations), collapse = "\n") )
    message("gut check first line\n", 
        paste( head(ijc_sex_results_refinedAnnotations,2), collapse = "\n") )

    # geneSymbols are in the annotations 
    ijc_sex_geneSymbols               <- ijc_sex_resultsAnnotations$geneSymbol
    ijc_sex_refined_geneSymbols       <- ijc_sex_results_refinedAnnotations$geneSymbol
    message("length ijc_sex_results_refined_geneSymbols\n", 
    ...
    dim(as_matrix)
    message("table sex\n", 
        paste(table(sex), collapse = "\n") )
    table(as_event)
    message("dim design <- model.matrix( ~sex + as_event + sex*as_event\n", 
        paste(dim(design), collapse = "\n") )
